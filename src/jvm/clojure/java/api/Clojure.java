/**
 * Copyright (c) Rich Hickey and Contributors. All rights reserved. The use and distribution terms
...
/**
 * The Clojure class provides a minimal interface to bootstrap Clojure access from other JVM
 * languages. It provides:
 *
 * <ol>
 *   <li>The ability to use Clojure's namespaces to locate an arbitrary <a
 *       href="http://clojure.org/vars">var</a>, returning the var's {@link clojure.lang.IFn}
 *       interface.
 *   <li>A convenience method <code>read</code> for reading data using Clojure's edn reader
 * </ol>
 *
 ...
 * plus.invoke(1, 2);</pre>
 *
 * <p>Functions in <code>clojure.core</code> are automatically loaded. Other namespaces can be
 * loaded via <code>require</code>:
 *
 * <pre>
 * IFn require = Clojure.var("clojure.core", "require");
 * require.invoke(Clojure.read("clojure.set"));</pre>
 *
 * <p><code>IFn</code>s can be passed to higher order functions, e.g. the example below passes
 * <code>plus</code> to <code>read</code>:
 *
 * <pre>
...
public class Clojure {
  ...
  /**
   * Read one object from the String s. Reads data in the <a href="http://edn-format.org">edn
   * format</a>.
   *
   * @param s a String
