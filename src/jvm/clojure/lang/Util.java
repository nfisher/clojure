...
public class Util {
  static EquivPred equivNull =
      new EquivPred() {
        public boolean equiv(Object k1, Object k2) {
          return k2 == null;
        }
      };
  static EquivPred equivEquals =
      new EquivPred() {
        public boolean equiv(Object k1, Object k2) {
          return k1.equals(k2);
        }
      };
  static EquivPred equivNumber =
      new EquivPred() {
        public boolean equiv(Object k1, Object k2) {
  ...
  public static boolean pcequiv(Object k1, Object k2) {
    if (k1 instanceof IPersistentCollection) return ((IPersistentCollection) k1).equiv(k2);
  ...
  public static int hasheq(Object o) {
    ...
    if (o instanceof String) return Murmur3.hashInt(o.hashCode());
    return o.hashCode();
  }
   ...
   * idiom:
   *
   * <p><code>throw sneakyThrow( some exception );</code>
   */
  ...
  public static Object loadWithClass(String scriptbase, Class<?> loadFrom)
      throws IOException, ClassNotFoundException {
    RT.init();
    Var.pushThreadBindings(RT.map(Compiler.LOADER, loadFrom.getClassLoader()));
    try {
