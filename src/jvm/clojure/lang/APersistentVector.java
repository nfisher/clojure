...
public abstract class APersistentVector extends AFn
  ...
  static boolean doEquals(IPersistentVector v, Object obj) {
    if (obj instanceof IPersistentVector) {
      ...
      if (ov.count() != v.count()) return false;
      for (int i = 0; i < v.count(); i++) {
        if (!Util.equals(v.nth(i), ov.nth(i))) return false;
      }
      return true;
  ...
  static boolean doEquiv(IPersistentVector v, Object obj) {
    if (obj instanceof IPersistentVector) {
      ...
      if (ov.count() != v.count()) return false;
      for (int i = 0; i < v.count(); i++) {
        if (!Util.equiv(v.nth(i), ov.nth(i))) return false;
      }
      return true;
    } else if (obj instanceof List) {
      Collection ma = (Collection) obj;
  ...
  public int indexOf(Object o) {
    for (int i = 0; i < count(); i++) if (Util.equiv(nth(i), o)) return i;
    return -1;
  }

  public int lastIndexOf(Object o) {
    for (int i = count() - 1; i >= 0; i--) if (Util.equiv(nth(i), o)) return i;
    return -1;
  }
  ...
  public ListIterator listIterator(final int index) {
    return new ListIterator() {
      ...
      public Object next() {
        if (nexti < count()) return nth(nexti++);
  ...
  public IMapEntry entryAt(Object key) {
    if (Util.isInteger(key)) {
      int i = ((Number) key).intValue();
      if (i >= 0 && i < count()) return MapEntry.create(key, nth(i));
    }
    return null;
  }
  ...
  public Object[] toArray() {
    ...
    for (int i = 0; i < count(); i++) ret[i] = nth(i);
    return ret;
  }
