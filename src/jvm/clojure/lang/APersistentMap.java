...
public abstract class APersistentMap extends AFn
      ...
      public boolean contains(Object o) {
        if (o instanceof Entry) {
          ...
          Entry found = entryAt(e.getKey());
            return found != null && Util.equals(found.getValue(), e.getValue());
        }
        return false;
      }
    };
  ...
  public static class KeySeq extends ASeq {
    ...
    public Iterator iterator() {
      if (iterable == null) return super.iterator();

      if (iterable instanceof IMapIterable) return ((IMapIterable) iterable).keyIterator();
  ...
  public static class ValSeq extends ASeq {
    ...
    public Iterator iterator() {
      ...
      if (iterable instanceof IMapIterable) return ((IMapIterable) iterable).valIterator();
