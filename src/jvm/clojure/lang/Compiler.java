...
public class Compiler implements Opcodes {
  ...
  public static final Var METHOD_RETURN_CONTEXT = Var.create(null).setDynamic();
  ...
  public static final Var INSTANCE =
      Var.intern(Namespace.findOrCreate(Symbol.intern("clojure.core")), Symbol.intern("instance?"));
  public static final Var ADD_ANNOTATIONS =
      Var.intern(
          Namespace.findOrCreate(Symbol.intern("clojure.core")), Symbol.intern("add-annotations"));
  public static final Keyword disableLocalsClearingKey = Keyword.intern("disable-locals-clearing");
  public static final Keyword directLinkingKey = Keyword.intern("direct-linking");
  public static final Keyword elideMetaKey = Keyword.intern("elide-meta");
  public static final Var COMPILER_OPTIONS;
  // Integer
  public static final Var LINE = Var.create(0).setDynamic();
  public static final Var COLUMN = Var.create(0).setDynamic();
  // Integer
  ...
  // PathNode chain
  public static final Var CLEAR_PATH = Var.create(null).setDynamic();
  // tail of PathNode chain
  public static final Var CLEAR_ROOT = Var.create(null).setDynamic();
  // LocalBinding -> Set<LocalBindingExpr>
  public static final Var CLEAR_SITES = Var.create(null).setDynamic();
  public static final Class RECUR_CLASS = Recur.class;
  ...
  public static final IPersistentMap specials =
      PersistentHashMap.create(
          ...
          IMPORT,
          new ImportExpr.Parser(),
          DOT,
          new HostExpr.Parser(),
          ASSIGN,
          new AssignExpr.Parser(),
          DEFTYPE,
          new NewInstanceExpr.DeftypeParser(),
          REIFY,
  ...
  static final Type TUPLE_TYPE = Type.getType(Tuple.class);
    static final Method[] createTupleMethods = {
            ...
            Method.getMethod(
                    "clojure.lang.IPersistentVector create(Object,Object,Object,Object,Object,Object)")
    };
  ...
  static boolean inTailCall(C context) {
    return (context == C.RETURN)
        && (METHOD_RETURN_CONTEXT.deref() != null)
  ...
  static String getTypeStringForArgs(IPersistentVector args) {
    ...
    for (int i = 0; i < args.count(); i++) {
      ...
      if (i > 0) sb.append(", ");
      sb.append(
          (arg.hasJavaClass() && arg.getJavaClass() != null)
  ...
  private static Expr analyzeSeq(C context, ISeq form, String name) {
    ...
    try {
      ...
      op = RT.first(form);
      if (op == null) throw new IllegalArgumentException("Can't call nil, form: " + form);
      IFn inline = isInline(op, RT.count(RT.next(form)));
      if (inline != null) return analyze(context, preserveTag(form, inline.applyTo(RT.next(form))));
      IParser p;
    ...
    try {
      ...
      try {
        ...
        if (form instanceof ISeq && Util.equals(RT.first(form), DO)) {
          ISeq s = RT.next(form);
          for (; RT.next(s) != null; s = RT.next(s)) eval(RT.first(s), false);
  ...
  private static void registerVarCallsite(Var v) {
    if (!VAR_CALLSITES.isBound()) throw new IllegalAccessError("VAR_CALLSITES is not bound");
  ...
  static ISeq fwdPath(PathNode p1) {
    ISeq ret = null;
    for (; p1 != null; p1 = p1.parent) ret = RT.cons(p1, ret);
    return ret;
  }
  ...
  static void addAnnotation(Object visitor, IPersistentMap meta) {
    if (meta != null && ADD_ANNOTATIONS.isBound()) ADD_ANNOTATIONS.invoke(visitor, meta);
  }

  static void addParameterAnnotation(Object visitor, IPersistentMap meta, int i) {
    if (meta != null && ADD_ANNOTATIONS.isBound()) ADD_ANNOTATIONS.invoke(visitor, meta, i);
  }
  ...
  static Type getType(Class c) {
    ...
    if (descriptor.startsWith("L")) descriptor = "L" + destubClassName(descriptor.substring(1));
  ...
  public static Object resolveIn(Namespace n, Symbol sym, boolean allowPrivate) {
    ...
    if (sym.ns != null) {
      ...
      if (ns == null) throw Util.runtimeException("No such namespace: " + sym.ns);
  ...
  //
  //	public KeywordSiteInvokeExpr(String source, int line, int column, Symbol tag, Expr site, Expr
  // target){
  //		this.source = source;
  //		this.site = site;
  //		this.target = target;
  ...
  static void closeOver(LocalBinding b, ObjMethod method) {
    if (b != null && method != null) {
      ...
      if (lb == null) {
        ...
        if (lb.idx == 0) method.usesThis = true;
  ...
  static LocalBinding referenceLocal(Symbol sym) {
    ...
    if (b != null) {
      ObjMethod method = (ObjMethod) METHOD.deref();
      if (b.idx == 0) method.usesThis = true;
      closeOver(b, method);
    }
    return b;
  }
  ...
  public static Object loadFile(String file) throws IOException {
    ...
    try {
      return load(
          new InputStreamReader(f, RT.UTF8),
  ...
  static void consumeWhitespaces(LineNumberingPushbackReader pushbackReader) {
    ...
    while (LispReader.isWhitespace(ch)) ch = LispReader.read1(pushbackReader);
    LispReader.unread(pushbackReader, ch);
  }

  private static Object readerOpts(String sourceName) {
    if (sourceName != null && sourceName.endsWith(".cljc")) return OPTS_COND_ALLOWED;
    else return null;
  }
  ...
  public static Object load(Reader rdr, String sourcePath, String sourceName) {
    ...
    try {
      for (Object r = LispReader.read(pushbackReader, false, EOF, false, readerOpts);
          r != EOF;
      ...
      throw new CompilerException(
          sourcePath, e.line, e.column, null, CompilerException.PHASE_READ, e.getCause());
    } catch (Throwable e) {
      if (!(e instanceof CompilerException))
        throw new CompilerException(
            sourcePath, (Integer) LINE_BEFORE.deref(), (Integer) COLUMN_BEFORE.deref(), e);
      else throw (CompilerException) e;
    } finally {
      Var.popThreadBindings();
    }
  ...
  public static void pushNS() {
    Var.pushThreadBindings(
        PersistentHashMap.create(
            Var.intern(Symbol.intern("clojure.core"), Symbol.intern("*ns*")).setDynamic(), null));
  }
  ...
  public static Object compile(Reader rdr, String sourcePath, String sourceName)
      throws IOException {
    if (COMPILE_PATH.deref() == null) throw Util.runtimeException("*compile-path* not set");
    ...
    try {
      ...
      objx.internalName =
          sourcePath.replace(File.separator, "/").substring(0, sourcePath.lastIndexOf('.'))
              + RT.LOADER_SUFFIX;
      ...
      GeneratorAdapter gen =
          new GeneratorAdapter(
              ACC_PUBLIC + ACC_STATIC, Method.getMethod("void load ()"), null, null, cv);
      gen.visitCode();
      ...
      clinitgen.invokeStatic(
          Type.getType(Compiler.class), Method.getMethod("void pushNSandLoader(ClassLoader)"));
  ...
  static Class retType(Class tc, Class ret) {
    if (tc == null) return ret;
    if (ret == null) return tc;
    if (ret.isPrimitive() && tc.isPrimitive()) {
      if ((inty(ret) && inty(tc)) || (ret == tc)) return tc;
      throw new UnsupportedOperationException(
          "Cannot coerce " + ret + " to " + tc + ", use a cast instead");
    }
    return tc;
  }
  ...
  public abstract static class UntypedExpr implements Expr {
  ...
  static class DefExpr implements Expr {
    ...
    static final Method internVar =
        Method.getMethod("clojure.lang.Var refer(clojure.lang.Symbol, clojure.lang.Var)");
    ...
    public Object eval() {
      try {
        ...
        if (!(e instanceof CompilerException))
          throw new CompilerException(
              source, line, column, Compiler.DEF, CompilerException.PHASE_EXECUTION, e);
        else throw (CompilerException) e;
      }
    }
    ...
    static class Parser implements IParser {
      public Expr parse(C context, Object form) {
        ...
        if (RT.count(form) > 3) throw Util.runtimeException("Too many arguments to def");
        else if (RT.count(form) < 2) throw Util.runtimeException("Too few arguments to def");
        ...
        if (!v.ns.equals(currentNS())) {
          ...
          //					                    " refers to:" + v);
          else throw Util.runtimeException("Can't create defs outside of current ns");
        }
        ...
        Expr meta =
            mm.count() == 0 ? null : analyze(context == C.EVAL ? context : C.EXPRESSION, mm);
        return new DefExpr(
            (String) SOURCE.deref(),
            lineDeref(),
            columnDeref(),
  ...
  public static class VarExpr implements Expr, AssignableExpr {
    ...
    public Class getJavaClass() {
      if (jc == null) jc = HostExpr.tagToClass(tag);
      return jc;
    }
  ...
  public abstract static class LiteralExpr implements Expr {
    abstract Object val();
  ...
  public abstract static class HostExpr implements Expr, MaybePrimitiveExpr {
      ...
      if (paramType.isPrimitive()) {
        if (paramType == boolean.class) {
          ...
          if (RT.booleanCast(Vars.UNCHECKED_MATH.deref())) {
            ...
            if (paramType == int.class) m = Method.getMethod("int intCast(Object)");
            else if (paramType == float.class) m = Method.getMethod("float floatCast(Object)");
            else if (paramType == double.class) m = Method.getMethod("double doubleCast(Object)");
            else if (paramType == long.class) m = Method.getMethod("long longCast(Object)");
            else if (paramType == byte.class) m = Method.getMethod("byte byteCast(Object)");
            else if (paramType == short.class) m = Method.getMethod("short shortCast(Object)");
          }
    ...
    public static Class maybeClass(Object form, boolean stringOk) {
      ...
      if (form instanceof Symbol) {
        ...
        {
          if (Util.equals(sym, COMPILE_STUB_SYM.get())) return (Class) COMPILE_STUB_CLASS.get();
          if (sym.name.indexOf('.') > 0 || sym.name.charAt(0) == '[')
            c = RT.classForNameNonLoading(sym.name);
          else {
            Object o = currentNS().getMapping(sym);
            if (o instanceof Class) c = (Class) o;
            else if (LOCAL_ENV.deref() != null
                && ((java.util.Map) LOCAL_ENV.deref()).containsKey(form)) return null;
            else {
              try {
                c = RT.classForNameNonLoading(sym.name);
              } catch (Exception e) {
      ...
      } else if (stringOk && form instanceof String) c = RT.classForNameNonLoading((String) form);
      return c;
    }
    ...
    */
    public static Class maybeSpecialTag(Symbol sym) {
      ...
      if (c != null) return c;
      else if (sym.name.equals("objects")) c = Object[].class;
    ...
    static Class tagToClass(Object tag) {
      ...
      if (c == null) c = maybeClass(tag, true);
      if (c != null) return c;
    ...
    static class Parser implements IParser {
      public Expr parse(C context, Object frm) {
        ...
        if (maybeField && !(((Symbol) RT.third(form)).name.charAt(0) == '-')) {
          ...
          if (c != null) maybeField = Reflector.getMethods(c, 0, munge(sym.name), true).size() == 0;
          else if (instance != null && instance.hasJavaClass() && instance.getJavaClass() != null)
            maybeField =
                Reflector.getMethods(instance.getJavaClass(), 0, munge(sym.name), false).size()
                    == 0;
        }
        ...
        if (maybeField) // field
        {
          ...
          ISeq call =
              (ISeq) ((RT.third(form) instanceof ISeq) ? RT.third(form) : RT.next(RT.next(form)));
          ...
          if (c != null)
            return new StaticMethodExpr(
                source, line, column, tag, c, munge(sym.name), args, tailPosition);
          else
            return new InstanceMethodExpr(
                source, line, column, tag, instance, munge(sym.name), args, tailPosition);
        }
      }
    }
  }
  ...
  static class InstanceFieldExpr extends FieldExpr implements AssignableExpr {
    ...
    public InstanceFieldExpr(
        int line, int column, Expr target, String fieldName, Symbol tag, boolean requireField) {
      this.target = target;
    ...
    public Class getJavaClass() {
      if (jc == null) jc = tag != null ? HostExpr.tagToClass(tag) : field.getType();
      return jc;
    }
      ...
      try {
        ...
        for (java.lang.reflect.Method m : c.getMethods())
          if (fieldName.equals(m.getName()) && (Modifier.isStatic(m.getModifiers())))
            throw new IllegalArgumentException(
                "No matching method " + fieldName + " found taking 0 args for " + c);
  ...
  abstract static class MethodExpr extends HostExpr {
    ...
    public static void emitTypedArgs(
        ObjExpr objx, GeneratorAdapter gen, Class[] parameterTypes, IPersistentVector args) {
  ...
  static class InstanceMethodExpr extends MethodExpr {
    ...
    public Object eval() {
      try {
        ...
        if (!(e instanceof CompilerException))
          throw new CompilerException(
              source, line, column, null, CompilerException.PHASE_EXECUTION, e);
        else throw (CompilerException) e;
      }
    }
    ...
    public Class getJavaClass() {
      if (jc == null)
        jc =
            retType(
                (tag != null) ? HostExpr.tagToClass(tag) : null,
  ...
  static class StaticMethodExpr extends MethodExpr {
    ...
    public static boolean isBoxedMath(java.lang.reflect.Method m) {
      ...
      if (c.equals(Numbers.class)) {
        ...
        if (boxedMath != null) return boxedMath.value();

        Class[] argTypes = m.getParameterTypes();
        for (Class argType : argTypes)
          if (argType.equals(Object.class) || argType.equals(Number.class)) return true;
      }
      return false;
    }
    ...
    public void emitIntrinsicPredicate(
        C context, ObjExpr objx, GeneratorAdapter gen, Label falseLabel) {
      gen.visitLineNumber(line, gen.mark());
      if (method != null) {
        MethodExpr.emitTypedArgs(objx, gen, method.getParameterTypes(), args);
        if (context == C.RETURN) {
        ...
        for (int i = 0; i < predOps.length - 1; i++) gen.visitInsn((Integer) predOps[i]);
      ...
      if (method != null) {
        ...
        if (ops != null) {
          if (ops instanceof Object[]) {
            for (Object op : (Object[]) ops) gen.visitInsn((Integer) op);
    ...
    public void emit(C context, ObjExpr objx, GeneratorAdapter gen) {
      if (method != null) {
        ...
        Method m =
            new Method(methodName, Type.getReturnType(method), Type.getArgumentTypes(method));
        gen.visitMethodInsn(
            INVOKESTATIC, type.getInternalName(), methodName, m.getDescriptor(), c.isInterface());
        // if(context != C.STATEMENT || method.getReturnType() == Void.TYPE)
  ...
  static class NumberExpr extends LiteralExpr implements MaybePrimitiveExpr {
    ...
    public Class getJavaClass() {
      ...
      else throw new IllegalStateException("Unsupported Number type: " + n.getClass().getName());
    }
  ...
  static class ConstantExpr extends LiteralExpr {
    ...
    public Class getJavaClass() {
      if (v instanceof APersistentMap) return APersistentMap.class;
      else if (v instanceof APersistentSet) return APersistentSet.class;
      else if (v instanceof APersistentVector) return APersistentVector.class;
      ...
      public Expr parse(C context, Object form) {
        ...
        if (argCount != 1) {
          ...
          throw new ExceptionInfo(
              "Wrong number of args (" + argCount + ") passed to quote", exData);
        }
            ...
            if (Util.equals(op, CATCH)) {
              ...
              try {
                ...
                LocalBinding lb =
                    registerLocal(
                        sym,
                        (Symbol) (RT.second(f) instanceof Symbol ? RT.second(f) : null),
                        null,
                        false);
                Expr handler =
                    (new BodyExpr.Parser()).parse(C.EXPRESSION, RT.next(RT.next(RT.next(f))));
  ...
  public static class NewExpr implements Expr {
    ...
    public NewExpr(Class c, IPersistentVector args, int line, int column) {
      ...
      if (ctors.isEmpty()) throw new IllegalArgumentException("No matching ctor found for " + c);
  ...
  public static class IfExpr implements Expr, MaybePrimitiveExpr {
    ...
    public void doEmit(C context, ObjExpr objx, GeneratorAdapter gen, boolean emitUnboxed) {
      ...
      if (emitUnboxed) ((MaybePrimitiveExpr) thenExpr).emitUnboxed(context, objx, gen);
      else thenExpr.emit(context, objx, gen);
      gen.goTo(endLabel);
      gen.mark(nullLabel);
      gen.pop();
      gen.mark(falseLabel);
      if (emitUnboxed) ((MaybePrimitiveExpr) elseExpr).emitUnboxed(context, objx, gen);
    ...
    public Class getJavaClass() {
      ...
      if (thenClass != null && thenClass != RECUR_CLASS) return thenClass;
    ...
    static class Parser implements IParser {
      public Expr parse(C context, Object frm) {
        ...
        if (form.count() > 4) throw Util.runtimeException("Too many arguments to if");
        else if (form.count() < 3) throw Util.runtimeException("Too few arguments to if");
  ...
  public static class MapExpr implements Expr {
    ...
    public static Expr parse(C context, IPersistentMap form) {
      ...
      if (form instanceof IObj && ((IObj) form).meta() != null)
        return new MetaExpr(
            ret, MapExpr.parse(context == C.EVAL ? context : C.EXPRESSION, ((IObj) form).meta()));
        ...
        if (valsConstant) {
          ...
          for (int i = 0; i < keyvals.length(); i += 2) {
            m =
                m.assoc(
                    ((LiteralExpr) keyvals.nth(i)).val(), ((LiteralExpr) keyvals.nth(i + 1)).val());
          }
  ...
  static class KeywordInvokeExpr implements Expr {
    ...
    public KeywordInvokeExpr(
        String source, int line, int column, Symbol tag, KeywordExpr kw, Expr target) {
      this.source = source;
      this.kw = kw;
      this.target = target;
      this.line = line;
    ...
    public void emit(C context, ObjExpr objx, GeneratorAdapter gen) {
      ...
      gen.invokeInterface(
          ObjExpr.ILOOKUP_THUNK_TYPE, Method.getMethod("Object get(Object)")); // result
  ...
  static class StaticInvokeExpr implements Expr, MaybePrimitiveExpr {
    ...
    public static Expr parse(Var v, ISeq args, Object tag, boolean tailPosition) {
      ...
      return new StaticInvokeExpr(
          target, retClass, paramClasses, paramTypes, variadic, argv, tag, tailPosition);
    }
    ...
    public Class getJavaClass() {
      if (jc == null) jc = retType((tag != null) ? HostExpr.tagToClass(tag) : null, retClass);
      return jc;
    }
  ...
  static class InvokeExpr implements Expr {
        ...
        if (!v.isDynamic() && !RT.booleanCast(RT.get(v.meta(), redefKey, false))) {
          ...
          Expr ret =
              StaticInvokeExpr.parse(
                  v,
                  RT.next(form),
                  formtag != null ? formtag : sigtag != null ? sigtag : vtag,
                  tailPosition);
          if (ret != null) {
    ...
    public void emitProto(C context, ObjExpr objx, GeneratorAdapter gen) {
      ...
      gen.getStatic(
          objx.objtype, objx.cachedClassName(siteIndex), CLASS_TYPE); // target,class,cached-class
      ...
      if (protocolOn != null) {
        ...
        MethodExpr.emitTypedArgs(
            objx, gen, onMethod.getParameterTypes(), RT.subvec(args, 1, args.count()));
        if (context == C.RETURN) {
          ObjMethod method = (ObjMethod) METHOD.deref();
          method.emitClearLocals(gen);
        }
        Method m =
            new Method(
                onMethod.getName(), Type.getReturnType(onMethod), Type.getArgumentTypes(onMethod));
  ...
  public static class FnExpr extends ObjExpr {
    ...
    static Expr parse(C context, ISeq form, String name) {
      ...
      String basename =
          (enclosingMethod != null ? enclosingMethod.objx.name : (munge(currentNS().name.name)))
              + "$";
      ...
      if (RT.second(form) instanceof Symbol) {
        ...
        if (name == null) name = "fn__" + RT.nextID();
        else if (enclosingMethod != null) name += "__" + RT.nextID();
      }
      ...
      try {
        ...
        if (RT.second(form) instanceof IPersistentVector) form = RT.list(FN, RT.next(form));
        fn.line = lineDeref();
        ...
        for (ISeq s = RT.next(form); s != null; s = RT.next(s)) {
          ...
          if (f.isVariadic()) {
            ...
            else throw Util.runtimeException("Can't have more than 1 variadic overload");
          } else if (methodArray[f.reqParms.count()] == null) methodArray[f.reqParms.count()] = f;
          else throw Util.runtimeException("Can't have 2 overloads with same arity");
    ...
    public Class getJavaClass() {
      if (jc == null) jc = tag != null ? HostExpr.tagToClass(tag) : AFunction.class;
      return jc;
    }
    ...
    protected void emitMethods(ClassVisitor cv) {
      ...
      if (isVariadic()) {
        GeneratorAdapter gen =
            new GeneratorAdapter(
                ACC_PUBLIC, Method.getMethod("int getRequiredArity()"), null, null, cv);
        gen.visitCode();
  ...
  public static class ObjExpr implements Expr {
    ...
    Type[] ctorTypes() {
      IPersistentVector tv =
          !supportsMeta() ? PersistentVector.EMPTY : RT.vector(IPERSISTENTMAP_TYPE);
    ...
    void compile(String superName, String[] interfaceNames, boolean oneTimeUse) throws IOException {
      ...
      cv.visit(
          V1_8, ACC_PUBLIC + ACC_SUPER + ACC_FINAL, internalName, null, superName, interfaceNames);
      ...
      for (ISeq s = RT.keys(closes); s != null; s = s.next()) {
        ...
        if (isDeftype()) {
          ...
          if (lb.getPrimitiveType() != null)
            ...
            // todo - when closed-overs are fields, use more specific types here and in ctor and
            // emitLocal?
          ...
          if (lb.getPrimitiveType() != null)
            cv.visitField(
                0 + (isVolatile(lb) ? ACC_VOLATILE : 0),
                lb.name,
                Type.getType(lb.getPrimitiveType()).getDescriptor(),
                null,
                null);
      ...
      for (int i = 0; i < protocolCallsites.count(); i++) {
        cv.visitField(
            ACC_PRIVATE + ACC_STATIC, cachedClassName(i), CLASS_TYPE.getDescriptor(), null, null);
      }
      ...
      if (altCtorDrops > 0) {
        ...
        for (int i = 0; i < altCtorTypes.length; i++) altCtorTypes[i] = ctorTypes[i];
      ...
      if (supportsMeta()) {
        ...
        for (int i = 1; i < ctorTypes.length; i++) noMetaCtorTypes[i - 1] = ctorTypes[i];
      ...
      for (int i = 0; i < keywordCallsites.count(); i++) {
        cv.visitField(
            ...
            null);
        cv.visitField(
            ACC_STATIC, thunkNameStatic(i), ILOOKUP_THUNK_TYPE.getDescriptor(), null, null);
      }
      ...
      if (isDeftype() && RT.booleanCast(RT.get(opts, loadNs))) {
        ...
        if (!nsname.equals("clojure.core")) {
          ...
          clinitgen.invokeStatic(
              SYMBOL_TYPE, Method.getMethod("clojure.lang.Symbol create(String)"));
      ...
      if (RT.booleanCast(COMPILE_FILES.deref())) writeClassFile(internalName, bytecode);
      //		else
      //			getCompiledClass();
    }
    ...
    private void emitKeywordCallsites(GeneratorAdapter clinitgen) {
      for (int i = 0; i < keywordCallsites.count(); i++) {
        ...
        clinitgen.invokeConstructor(
            KEYWORD_LOOKUPSITE_TYPE, Method.getMethod("void <init>(clojure.lang.Keyword)"));
        clinitgen.dup();
    ...
    void emitValue(Object value, GeneratorAdapter gen) {
      ...
      if (value == null) gen.visitInsn(Opcodes.ACONST_NULL);
        ...
        gen.invokeStatic(
            Type.getType(Character.class), Method.getMethod("Character valueOf(char)"));
        ...
        if (cc.isPrimitive()) {
          ...
          else throw Util.runtimeException("Can't embed unknown primitive in code: " + value);
      ...
      //								}
        ...
        Method ctor =
            new Method(
                "<init>", Type.getConstructorDescriptor(value.getClass().getConstructors()[0]));
        gen.newInstance(Type.getType(value.getClass()));
        gen.dup();
        IPersistentVector fields =
            (IPersistentVector)
                Reflector.invokeStaticMethod(value.getClass(), "getBasis", new Object[] {});
        ...
        Method createMethod =
            Method.getMethod(value.getClass().getName() + " create(clojure.lang.IPersistentMap)");
        ...
        if (args.count() <= Tuple.MAX_SIZE) {
          ...
          gen.invokeStatic(
              RT_TYPE, Method.getMethod("clojure.lang.IPersistentVector vector(Object[])"));
        }
        ...
        try {
          ...
          throw Util.runtimeException(
              "Can't embed object in code, maybe print-dup not defined: " + value);
        }
        if (cs.length() == 0)
    ...
    public Class getJavaClass() {
      if (jc == null)
        jc =
            (compiledClass != null)
                ? compiledClass
                : (tag != null) ? HostExpr.tagToClass(tag) : IFn.class;
      return jc;
    }
    ...
    Type constantType(int id) {
      ...
      if (c != null && Modifier.isPublic(c.getModifiers())) {
        ...
        else if (RestFn.class.isAssignableFrom(c)) return Type.getType(RestFn.class);
  ...
  public static class FnMethod extends ObjMethod {
    ...
    public static String primInterface(IPersistentVector arglist) {
      StringBuilder sb = new StringBuilder();
      for (int i = 0; i < arglist.count(); i++) sb.append(classChar(tagOf(arglist.nth(i))));
    ...
    static FnMethod parse(ObjExpr objx, ISeq form, Object rettag) {
      ...
      try {
        ...
        if (rettag instanceof String) rettag = Symbol.intern(null, (String) rettag);
        if (!(rettag instanceof Symbol)) rettag = null;
        if (rettag != null) {
          String retstr = ((Symbol) rettag).getName();
          if (!(retstr.equals("long") || retstr.equals("double"))) rettag = null;
        }
        ...
        if (method.retClass.isPrimitive()) {
          if (!(method.retClass == double.class || method.retClass == long.class))
            throw new IllegalArgumentException("Only long and double primitives are supported");
        } else method.retClass = Object.class;
        // register 'this' as local 0
        // registerLocal(THISFN, null, null);
        //			if(!canBeDirect)
        //				{
        if (objx.thisName != null) registerLocal(Symbol.intern(objx.thisName), null, null, false);
        ...
        if (method.reqParms.count() > MAX_POSITIONAL_ARITY)
          throw Util.runtimeException(
              "Can't specify more than " + MAX_POSITIONAL_ARITY + " params");
    ...
    public void doEmitStatic(ObjExpr fn, ClassVisitor cv) {
      ...
      try {
        ...
        for (ISeq lbs = argLocals.seq(); lbs != null; lbs = lbs.next()) {
          ...
          gen.visitLocalVariable(
              lb.name, argtypes[lb.idx].getDescriptor(), null, loopLabel, end, lb.idx);
        }
      } finally {
        Var.popThreadBindings();
      }
      ...
      if (prim != null) {
        if (retClass == double.class || retClass == long.class) returnType = getReturnType();
        else returnType = OBJECT_TYPE;
    ...
    public void doEmitPrim(ObjExpr fn, ClassVisitor cv) {
      ...
      try {
        ...
        for (ISeq lbs = argLocals.seq(); lbs != null; lbs = lbs.next()) {
          LocalBinding lb = (LocalBinding) lbs.first();
          gen.visitLocalVariable(
              lb.name, argtypes[lb.idx - 1].getDescriptor(), null, loopLabel, end, lb.idx);
        }
      } finally {
        Var.popThreadBindings();
      }
    ...
    Type[] getArgTypes() {
      if (isVariadic() && reqParms.count() == MAX_POSITIONAL_ARITY) {
        ...
        for (int i = 0; i < MAX_POSITIONAL_ARITY + 1; i++) ret[i] = OBJECT_TYPE;
        return ret;
      }
  ...
  public abstract static class ObjMethod {
    ...
    public boolean hasJavaClass() {
      if (hjc == null) {
        if (init != null
            ...
            && !(init instanceof MaybePrimitiveExpr)) hjc = false;
        else hjc = tag != null || (init != null && init.hasJavaClass());
      }
      return hjc;
    }

    public Class getJavaClass() {
      if (jc == null) jc = tag != null ? HostExpr.tagToClass(tag) : init.getJavaClass();
      return jc;
    }
  ...
  public static class LocalBindingExpr implements Expr, MaybePrimitiveExpr, AssignableExpr {
    ...
    public Class getJavaClass() {
      if (jc == null) {
        if (tag != null) jc = HostExpr.tagToClass(tag);
        else jc = b.getJavaClass();
      }
      return jc;
    }
  }
    ...
    static class Parser implements IParser {
      public Expr parse(C context, Object frms) {
        ...
        for (; forms != null; forms = forms.next()) {
          Expr e =
              (context != C.EVAL && (context == C.STATEMENT || forms.next() != null))
  ...
  public static class LetFnExpr implements Expr {
    ...
    public void emit(C context, ObjExpr objx, GeneratorAdapter gen) {
      ...
      for (ISeq bis = bindingInits.seq(); bis != null; bis = bis.next()) {
        ...
        if (primc != null)
          gen.visitLocalVariable(
              lname, Type.getDescriptor(primc), null, loopLabel, end, bi.binding.idx);
        else
  ...
  public static class LetExpr implements Expr, MaybePrimitiveExpr {
    ...
    public void doEmit(C context, ObjExpr objx, GeneratorAdapter gen, boolean emitUnboxed) {
      ...
      for (int i = 0; i < bindingInits.count(); i++) {
        ...
        if (primc != null) {
          ...
          bi.init.emit(C.EXPRESSION, objx, gen);
          if (!bi.binding.used && bi.binding.canBeCleared) gen.pop();
          else gen.visitVarInsn(OBJECT_TYPE.getOpcode(Opcodes.ISTORE), bi.binding.idx);
        }
      ...
      if (isLoop) {
        try {
          ...
          if (emitUnboxed) ((MaybePrimitiveExpr) body).emitUnboxed(context, objx, gen);
      ...
      for (ISeq bis = bindingInits.seq(); bis != null; bis = bis.next()) {
        ...
        if (primc != null)
          gen.visitLocalVariable(
              lname, Type.getDescriptor(primc), null, bindingLabels.get(bi), end, bi.binding.idx);
        else
          gen.visitLocalVariable(
              lname, "Ljava/lang/Object;", null, bindingLabels.get(bi), end, bi.binding.idx);
      }
    }
    ...
    static class Parser implements IParser {
      public Expr parse(C context, Object frm) {
        ...
        while (true) {
          IPersistentMap dynamicBindings =
              RT.map(LOCAL_ENV, LOCAL_ENV.deref(), NEXT_LOCAL_NUM, NEXT_LOCAL_NUM.deref());
          ...
          try {
            ...
            for (int i = 0; i < bindings.count(); i += 2) {
                ...
                if (recurMismatches != null && RT.booleanCast(recurMismatches.nth(i / 2))) {
                  ...
                  init =
                      new StaticMethodExpr(
                          "", 0, 0, null, RT.class, "longCast", RT.vector(init), false);
                else if (maybePrimitiveType(init) == float.class)
                  init =
                      new StaticMethodExpr(
                          "", 0, 0, null, RT.class, "doubleCast", RT.vector(init), false);
              }
              ...
              try {
                ...
                if (isLoop) Var.popThreadBindings();
              }
            }
            ...
            try {
              if (isLoop) {
                Object methodReturnContext =
                    context == C.RETURN ? METHOD_RETURN_CONTEXT.deref() : null;
                Var.pushThreadBindings(
                    RT.map(
                        CLEAR_PATH,
                        clearpath,
            ...
            if (!moreMismatches) return new LetExpr(bindingInits, bodyExpr, isLoop);
          } finally {
            Var.popThreadBindings();
          }
        }
  ...
  public static class RecurExpr implements Expr, MaybePrimitiveExpr {
    ...
    public RecurExpr(
        IPersistentVector loopLocals, IPersistentVector args, int line, int column, String source) {
    ...
    public void emit(C context, ObjExpr objx, GeneratorAdapter gen) {
      ...
      for (int i = 0; i < loopLocals.count(); i++) {
        ...
        if (lb.getPrimitiveType() != null) {
          ...
          if (pc == primc) ((MaybePrimitiveExpr) arg).emitUnboxed(C.EXPRESSION, objx, gen);
      ...
      for (int i = loopLocals.count() - 1; i >= 0; i--) {
        LocalBinding lb = (LocalBinding) loopLocals.nth(i);
        Class primc = lb.getPrimitiveType();
        if (lb.isArg) gen.storeArg(lb.idx - (objx.canBeDirect ? 0 : 1));
        else {
          if (primc != null)
  ...
  public static class CompilerException extends RuntimeException implements IExceptionInfo {
    ...
    public static final Keyword ERR_SOURCE = Keyword.intern(ERR_NS, "source");
    public static final Keyword ERR_LINE = Keyword.intern(ERR_NS, "line");
    public static final Keyword ERR_COLUMN = Keyword.intern(ERR_NS, "column");
    public static final Keyword ERR_PHASE = Keyword.intern(ERR_NS, "phase");
    public static final Keyword ERR_SYMBOL = Keyword.intern(ERR_NS, "symbol");
    // Compile error phases
    public static final Keyword PHASE_READ = Keyword.intern(null, "read-source");
    public static final Keyword PHASE_MACRO_SYNTAX_CHECK =
        Keyword.intern(null, "macro-syntax-check");
    public static final Keyword PHASE_MACROEXPANSION = Keyword.intern(null, "macroexpansion");
    public static final Keyword PHASE_COMPILE_SYNTAX_CHECK =
        Keyword.intern(null, "compile-syntax-check");
    public static final Keyword PHASE_COMPILATION = Keyword.intern(null, "compilation");
    public static final Keyword PHASE_EXECUTION = Keyword.intern(null, "execution");
    ...
    public CompilerException(
        String source, int line, int column, Symbol sym, Keyword phase, Throwable cause) {
    ...
    public static String makeMsg(
      ...
      return (PHASE_MACROEXPANSION.equals(phase) ? "Unexpected error " : "Syntax error ")
          ...
          + (sym != null ? sym + " " : "")
          + "at ("
          + (source != null && !source.equals("NO_SOURCE_PATH") ? (source + ":") : "")
          + line
          + ":"
          + column
          + ").";
    ...
    public String toString() {
      ...
      if (cause != null) {
        if (cause instanceof IExceptionInfo) {
          ...
          if (PHASE_MACRO_SYNTAX_CHECK.equals(data.valAt(ERR_PHASE))
              && data.valAt(SPEC_PROBLEMS) != null) {
  ...
  public static class NewInstanceExpr extends ObjExpr {
    ...
    static ObjExpr build(
      ...
      if (fieldSyms != null) {
        ...
        for (int i = 0; i < fieldSyms.count(); i++) {
          ...
          LocalBinding lb =
              new LocalBinding(
                  -1, sym, null, new MethodParamExpr(tagClass(tagOf(sym))), false, null);
      ...
      try {
        ...
        for (ISeq s = methodForms; s != null; s = RT.next(s)) {
          NewInstanceMethod m =
              NewInstanceMethod.parse(ret, (ISeq) RT.first(s), thistag, overrideables);
    ...
    /**
     * * Current host interop uses reflection, which requires pre-existing classes Work around this
     * by: Generate a stub class that has the same interfaces and fields as the class we are
     * generating. Use it as a type hint for this, and bind the simple name of the class to this
     * stub (in resolve etc) Unmunge the name (using a magic prefix) on any code gen for classes
     */
    static Class compileStub(
      ...
      for (ISeq s = RT.keys(ret.closes); s != null; s = s.next()) {
        LocalBinding lb = (LocalBinding) s.first();
        int access =
            ACC_PUBLIC + (ret.isVolatile(lb) ? ACC_VOLATILE : ret.isMutable(lb) ? 0 : ACC_FINAL);
        if (lb.getPrimitiveType() != null)
          cv.visitField(
              access, lb.name, Type.getType(lb.getPrimitiveType()).getDescriptor(), null, null);
        else
          // todo - when closed-overs are fields, use more specific types here and in ctor and
          // emitLocal?
    ...
    static String[] interfaceNames(IPersistentVector interfaces) {
      ...
      for (int i = 0; i < icnt; i++) inames[i] = slashname((Class) interfaces.nth(i));
      return inames;
    }
    ...
    static void gatherMethods(Class c, Map mm) {
      for (; c != null; c = c.getSuperclass()) {
        for (java.lang.reflect.Method m : c.getDeclaredMethods()) considerMethod(m, mm);
        for (java.lang.reflect.Method m : c.getMethods()) considerMethod(m, mm);
      }
    }
        ...
        if (this.isDeftype() && this.fields.count() > this.hintedFields.count()) {
          ...
          MethodVisitor mv =
              cv.visitMethod(
                  ACC_PUBLIC + ACC_STATIC,
                  "create",
                  "(Lclojure/lang/IPersistentMap;)L" + className + ";",
                  null,
                  null);
          mv.visitCode();
    ...
    static class ReifyParser implements IParser {
      public Expr parse(C context, Object frm) {
        ...
        IPersistentVector interfaces =
            ((IPersistentVector) RT.first(rform)).cons(Symbol.intern("clojure.lang.IObj"));
        ...
        if (frm instanceof IObj && ((IObj) frm).meta() != null)
          return new MetaExpr(
              ret, MapExpr.parse(context == C.EVAL ? context : C.EXPRESSION, ((IObj) frm).meta()));
        else return ret;
      }
    }
  }
  ...
  public static class NewInstanceMethod extends ObjMethod {
    ...
    public void emit(ObjExpr obj, ClassVisitor cv) {
      ...
      if (exclasses.length > 0) {
        ...
        for (int i = 0; i < exclasses.length; i++) extypes[i] = Type.getType(exclasses[i]);
      }
  ...
  public static class CaseExpr implements Expr, MaybePrimitiveExpr {
    ...
    private static void emitExpr(
        ObjExpr objx, GeneratorAdapter gen, Expr expr, boolean emitUnboxed) {
    ...
    public void doEmit(C context, ObjExpr objx, GeneratorAdapter gen, boolean emitUnboxed) {
      ...
      if (testType == intKey) emitExprForInts(objx, gen, primExprType, defaultLabel);
    ...
    private void emitThenForHashes(
        ObjExpr objx,
        GeneratorAdapter gen,
        Expr test,
        Expr then,
