...
public class LockingTransaction {
  ...
  static final ThreadLocal<LockingTransaction> transaction = new ThreadLocal<LockingTransaction>();
  ...
  static LockingTransaction getEx() {
    ...
    if (t == null || t.info == null) throw new IllegalStateException("No transaction running");
    return t;
  }
