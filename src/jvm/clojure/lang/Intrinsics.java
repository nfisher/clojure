...
public class Intrinsics implements Opcodes {
  static IPersistentMap ops =
      RT.map(
          ...
          AALOAD,
          "public static int clojure.lang.RT.alength(int[])",
          ARRAYLENGTH,
          "public static int clojure.lang.RT.alength(long[])",
          ARRAYLENGTH,
          "public static int clojure.lang.RT.alength(char[])",
          ARRAYLENGTH,
          "public static int clojure.lang.RT.alength(java.lang.Object[])",
          ARRAYLENGTH,
          "public static int clojure.lang.RT.alength(byte[])",
          ARRAYLENGTH,
          "public static int clojure.lang.RT.alength(float[])",
          ARRAYLENGTH,
          "public static int clojure.lang.RT.alength(short[])",
          ARRAYLENGTH,
          "public static int clojure.lang.RT.alength(boolean[])",
          ARRAYLENGTH,
          "public static int clojure.lang.RT.alength(double[])",
          ARRAYLENGTH,
          "public static double clojure.lang.RT.doubleCast(long)",
          L2D,
          "public static double clojure.lang.RT.doubleCast(double)",
          NOP,
          "public static double clojure.lang.RT.doubleCast(float)",
          F2D,
          "public static double clojure.lang.RT.doubleCast(int)",
          I2D,
          "public static double clojure.lang.RT.doubleCast(short)",
          I2D,
          "public static double clojure.lang.RT.doubleCast(byte)",
          I2D,
          ...
          NOP,
          "public static long clojure.lang.RT.longCast(short)",
          I2L,
          "public static long clojure.lang.RT.longCast(byte)",
          I2L,
          "public static long clojure.lang.RT.longCast(int)",
          I2L,
          "public static int clojure.lang.RT.uncheckedIntCast(long)",
          L2I,
          "public static int clojure.lang.RT.uncheckedIntCast(double)",
          D2I,
          ...
          NOP,
          "public static int clojure.lang.RT.uncheckedIntCast(float)",
          F2I,
          "public static long clojure.lang.RT.uncheckedLongCast(short)",
          I2L,
          "public static long clojure.lang.RT.uncheckedLongCast(float)",
          F2L,
          "public static long clojure.lang.RT.uncheckedLongCast(double)",
          D2L,
          "public static long clojure.lang.RT.uncheckedLongCast(byte)",
          I2L,
          "public static long clojure.lang.RT.uncheckedLongCast(long)",
          NOP,
          "public static long clojure.lang.RT.uncheckedLongCast(int)",
          I2L);
  // map to instructions terminated with comparator for branch to false
  static IPersistentMap preds =
      RT.map(
