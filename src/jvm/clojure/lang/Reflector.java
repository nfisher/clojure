...
public class Reflector {
  ...
  static Object invokeMatchingMethod(
  ...
  public static Object invokeStaticMethodVariadic(
  ...
  public static Object invokeNoArgInstanceMember(Object target, String name, boolean requireField) {
    ...
    if (requireField) {
      ...
      if (meths.size() > 0) return invokeMatchingMethod(name, meths, target, RT.EMPTY_ARRAY);
  ...
  static Object boxArg(Class paramType, Object arg) {
    ...
    else if (paramType == boolean.class) return (Boolean) arg;
    else if (paramType == char.class) return (Character) arg;
