...
public class ArraySeq extends ASeq implements IndexedSeq, IReduce {
  ...
  static ISeq createFromObject(Object array) {
    ...
    if (aclass == short[].class) return new ArraySeq_short(null, (short[]) array, 0);
  ...
  public ISeq next() {
    if (array != null && i + 1 < array.length) return new ArraySeq(array, i + 1);
    return null;
  }

  public int count() {
    if (array != null) return array.length - i;
    return 0;
  }
  ...
  public int indexOf(Object o) {
    if (array != null)
      for (int j = i; j < array.length; j++) if (Util.equals(o, array[j])) return j - i;
    return -1;
  }
  ...
  public int lastIndexOf(Object o) {
    if (array != null) {
      if (o == null) {
        for (int j = array.length - 1; j >= i; j--) if (array[j] == null) return j - i;
      } else {
        for (int j = array.length - 1; j >= i; j--) if (o.equals(array[j])) return j - i;
      }
    }
    return -1;
  }
  ...
  public static class ArraySeq_int extends ASeq implements IndexedSeq, IReduce {
    ...
    public int indexOf(Object o) {
      if (o instanceof Number) {
        ...
        for (int j = i; j < array.length; j++) if (k == array[j]) return j - i;
      }
    ...
    public int lastIndexOf(Object o) {
      if (o instanceof Number) {
        int k = ((Number) o).intValue();
        for (int j = array.length - 1; j >= i; j--) if (k == array[j]) return j - i;
      }
  ...
  public static class ArraySeq_float extends ASeq implements IndexedSeq, IReduce {
    ...
    public int indexOf(Object o) {
      if (o instanceof Number) {
        ...
        for (int j = i; j < array.length; j++) if (f == array[j]) return j - i;
      }
      return -1;
    }
    ...
    public int lastIndexOf(Object o) {
      if (o instanceof Number) {
        float f = ((Number) o).floatValue();
        for (int j = array.length - 1; j >= i; j--) if (f == array[j]) return j - i;
      }
      return -1;
    }
  }
  ...
  public static class ArraySeq_double extends ASeq implements IndexedSeq, IReduce {
    ...
    public int indexOf(Object o) {
      if (o instanceof Number) {
        ...
        for (int j = i; j < array.length; j++) if (d == array[j]) return j - i;
      }
    ...
    public int lastIndexOf(Object o) {
      if (o instanceof Number) {
        double d = ((Number) o).doubleValue();
        for (int j = array.length - 1; j >= i; j--) if (d == array[j]) return j - i;
      }
  ...
  public static class ArraySeq_long extends ASeq implements IndexedSeq, IReduce {
    ...
    public int indexOf(Object o) {
      if (o instanceof Number) {
        ...
        for (int j = i; j < array.length; j++) if (l == array[j]) return j - i;
      }
    ...
    public int lastIndexOf(Object o) {
      if (o instanceof Number) {
        long l = ((Number) o).longValue();
        for (int j = array.length - 1; j >= i; j--) if (l == array[j]) return j - i;
      }
  ...
  public static class ArraySeq_byte extends ASeq implements IndexedSeq, IReduce {
    ...
    public int indexOf(Object o) {
      if (o instanceof Byte) {
        ...
        for (int j = i; j < array.length; j++) if (b == array[j]) return j - i;
      }
      if (o == null) {
        return -1;
      }
      for (int j = i; j < array.length; j++) if (o.equals(array[j])) return j - i;
      return -1;
    }
    ...
    public int lastIndexOf(Object o) {
      if (o instanceof Byte) {
        byte b = ((Byte) o).byteValue();
        for (int j = array.length - 1; j >= i; j--) if (b == array[j]) return j - i;
      }
      if (o == null) {
        return -1;
      }
  ...
  public static class ArraySeq_char extends ASeq implements IndexedSeq, IReduce {
    ...
    public int indexOf(Object o) {
      if (o instanceof Character) {
        ...
        for (int j = i; j < array.length; j++) if (c == array[j]) return j - i;
      }
      if (o == null) {
        return -1;
      }
    ...
    public int lastIndexOf(Object o) {
      if (o instanceof Character) {
        char c = ((Character) o).charValue();
        for (int j = array.length - 1; j >= i; j--) if (c == array[j]) return j - i;
      }
      if (o == null) {
        return -1;
      }
  ...
  public static class ArraySeq_short extends ASeq implements IndexedSeq, IReduce {
    ...
    public ISeq next() {
      if (i + 1 < array.length) return new ArraySeq_short(meta(), array, i + 1);
      return null;
    }
    ...
    public int indexOf(Object o) {
      if (o instanceof Short) {
        ...
        for (int j = i; j < array.length; j++) if (s == array[j]) return j - i;
      }
      if (o == null) {
        return -1;
      }
    ...
    public int lastIndexOf(Object o) {
      if (o instanceof Short) {
        short s = ((Short) o).shortValue();
        for (int j = array.length - 1; j >= i; j--) if (s == array[j]) return j - i;
      }
      if (o == null) {
        return -1;
      }
  ...
  public static class ArraySeq_boolean extends ASeq implements IndexedSeq, IReduce {
    ...
    public ISeq next() {
      if (i + 1 < array.length) return new ArraySeq_boolean(meta(), array, i + 1);
      return null;
    }
