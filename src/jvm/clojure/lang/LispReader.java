...
public class LispReader {
  ...
  // Reader opts
  public static final Keyword OPT_EOF = Keyword.intern(null, "eof");
  public static final Keyword OPT_FEATURES = Keyword.intern(null, "features");
  public static final Keyword OPT_READ_COND = Keyword.intern(null, "read-cond");
  // EOF special value to throw on eof
  public static final Keyword EOFTHROW = Keyword.intern(null, "eofthrow");
  // Reader conditional options - use with :read-cond
  public static final Keyword COND_ALLOW = Keyword.intern(null, "allow");
  public static final Keyword COND_PRESERVE = Keyword.intern(null, "preserve");
  static final Symbol QUOTE = Symbol.intern("quote");
  static final Symbol THE_VAR = Symbol.intern("var");
  // Platform features - always installed
  private static final Keyword PLATFORM_KEY = Keyword.intern(null, "clj");
  private static final Object PLATFORM_FEATURES = PersistentHashSet.create(PLATFORM_KEY);
  ...
  public static Object read(
      PushbackReader r, boolean eofIsError, Object eofValue, boolean isRecursive, Object opts) {
  ...
  private static Object ensurePending(Object pendingForms) {
    if (pendingForms == null) return new LinkedList();
    else return pendingForms;
  }

  private static Object installPlatformFeature(Object opts) {
    if (opts == null) return RT.mapUniqueKeys(LispReader.OPT_FEATURES, PLATFORM_FEATURES);
    else {
      IPersistentMap mopts = (IPersistentMap) opts;
      Object features = mopts.valAt(OPT_FEATURES);
      if (features == null) return mopts.assoc(LispReader.OPT_FEATURES, PLATFORM_FEATURES);
      else
        return mopts.assoc(
            LispReader.OPT_FEATURES, RT.conj((IPersistentSet) features, PLATFORM_KEY));
    }
  }
  ...
  private static Object read(
    ...
    try {
      ...
      if (isRecursive || !(r instanceof LineNumberingPushbackReader)) throw Util.sneakyThrow(e);
  ...
  private static Object matchSymbol(String s, Resolver resolver) {
    ...
    if (m.matches()) {
      ...
      if (s.startsWith("::")) {
        ...
        if (resolver != null) {
          Symbol nsym;
          if (ks.ns != null) nsym = resolver.resolveAlias(Symbol.intern(ks.ns));
          else nsym = resolver.currentNS();
          // auto-resolving keyword
          if (nsym != null) return Keyword.intern(nsym.name, ks.name);
          else return null;
        } else {
          Namespace kns;
          if (ks.ns != null) kns = Compiler.currentNS().lookupAlias(Symbol.intern(ks.ns));
  ...
  public static List readDelimitedList(
      char delim, PushbackReader r, boolean isRecursive, Object opts, Object pendingForms) {
    final int firstline =
        (r instanceof LineNumberingPushbackReader)
            ? ((LineNumberingPushbackReader) r).getLineNumber()
            : -1;
    ...
    for (; ; ) {
      ...
      Object form =
          read(r, false, READ_EOF, delim, READ_FINISHED, isRecursive, opts, pendingForms, resolver);

      if (form == READ_EOF) {
        if (firstline < 0) throw Util.runtimeException("EOF while reading");
        else throw Util.runtimeException("EOF while reading, starting at line " + firstline);
  ...
  */
            ...
            default:
              {
                ...
                } else throw Util.runtimeException("Unsupported escape character: \\" + (char) ch);
              }
          }
        }
        sb.append((char) ch);
  ...
  public static class NamespaceMapReader extends AFn {
    public Object invoke(Object reader, Object colon, Object opts, Object pendingForms) {
      ...
      if (autoChar == ':') auto = true;
      else unread(r, autoChar);

      Object sym = null;
      int nextChar = read1(r);
      if (isWhitespace(nextChar)) { // the #:: { } case or an error
        if (auto) {
          while (isWhitespace(nextChar)) nextChar = read1(r);
          if (nextChar != '{') {
            unread(r, nextChar);
      ...
      if (nextChar != '{') throw Util.runtimeException("Namespaced map must specify a map");
      ...
      if (auto) {
        ...
        if (sym == null) {
          ...
          Symbol resolvedNS;
          if (resolver != null) resolvedNS = resolver.resolveAlias((Symbol) sym);
          else {
  ...
  public static class SymbolicValueReader extends AFn {
    ...
    public Object invoke(Object reader, Object quote, Object opts, Object pendingForms) {
      ...
      if (!(o instanceof Symbol)) throw Util.runtimeException("Invalid token: ##" + o);
      if (!(specials.containsKey(o))) throw Util.runtimeException("Unknown symbolic value: ##" + o);
  ...
  public static class DeprecatedWrappingReader extends AFn {
    ...
    public Object invoke(Object reader, Object quote, Object opts, Object pendingForms) {
      System.out.println(
          "WARNING: reader macro " + macro + " is deprecated; use " + sym.getName() + " instead");
      PushbackReader r = (PushbackReader) reader;
      Object o = read(r, true, null, true, opts, ensurePending(pendingForms));
      return RT.list(sym, o);
    }
  ...
  public static class DispatchReader extends AFn {
    public Object invoke(Object reader, Object hash, Object opts, Object pendingForms) {
      ...
      if (fn == null) {
        ...
        else throw Util.runtimeException(String.format("No dispatch macro for: %c", (char) ch));
      }
  ...
  public static class FnReader extends AFn {
    public Object invoke(Object reader, Object lparen, Object opts, Object pendingForms) {
      PushbackReader r = (PushbackReader) reader;
      if (ARG_ENV.deref() != null) throw new IllegalStateException("Nested #()s are not allowed");
      try {
  ...
  public static class MetaReader extends AFn {
    public Object invoke(Object reader, Object caret, Object opts, Object pendingForms) {
      ...
      } else throw new IllegalArgumentException("Metadata can only be applied to IMetas");
    }
  }
  ...
  */
    ...
    static Object syntaxQuote(Object form) {
      ...
      if (Compiler.isSpecial(form)) ret = RT.list(Compiler.QUOTE, form);
        ...
        if (sym.ns == null && sym.name.endsWith("#")) {
          ...
          if (gmap == null) throw new IllegalStateException("Gensym literal not in syntax-quote");
          ...
          if (resolver != null) {
            ...
            if (rc != null) csym = rc;
          } else csym = Compiler.resolveSymbol(csym);
      ...
      else if (isUnquoteSplicing(form)) throw new IllegalStateException("splice not in list");
        ...
        if (form instanceof IRecord) ret = form;
          ...
          ret =
              RT.list(
                  APPLY,
                  VECTOR,
                  RT.list(SEQ, RT.cons(CONCAT, sqExpandList(((IPersistentVector) form).seq()))));
        } else if (form instanceof IPersistentSet) {
          ret =
              RT.list(
                  APPLY,
                  HASHSET,
                  RT.list(SEQ, RT.cons(CONCAT, sqExpandList(((IPersistentSet) form).seq()))));
          ...
          || form instanceof String) ret = form;
  ...
  public static class VectorReader extends AFn {
    public Object invoke(Object reader, Object leftparen, Object opts, Object pendingForms) {
      PushbackReader r = (PushbackReader) reader;
      return LazilyPersistentVector.create(
          readDelimitedList(']', r, true, opts, ensurePending(pendingForms)));
    }
  }
  ...
  public static class SetReader extends AFn {
    public Object invoke(Object reader, Object leftbracket, Object opts, Object pendingForms) {
      PushbackReader r = (PushbackReader) reader;
      return PersistentHashSet.createWithCheck(
          readDelimitedList('}', r, true, opts, ensurePending(pendingForms)));
    }
  }
  ...
  public static class CtorReader extends AFn {
    public Object invoke(Object reader, Object firstChar, Object opts, Object pendingForms) {
      ...
      if (!(name instanceof Symbol)) throw new RuntimeException("Reader tag must be a symbol");
      ...
      if (isPreserveReadCond(opts) || RT.suppressRead()) {
        ...
        return sym.getName().contains(".")
            ? readRecord(form, sym, opts, pendingForms)
            : readTagged(form, sym, opts, pendingForms);
      }
    }
    ...
    private Object readRecord(Object form, Symbol recordName, Object opts, Object pendingForms) {
      ...
      if (form instanceof IPersistentMap) {
        ...
        throw Util.runtimeException(
            "Unreadable constructor form starting with \"#" + recordName + "\"");
      }
  ...
  public static class ConditionalReader extends AFn {
    ...
    public static final IPersistentSet RESERVED_FEATURES =
    ...
    public static Object readCondDelimited(
        PushbackReader r, boolean splicing, Object opts, Object pendingForms) {
